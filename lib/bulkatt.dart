...
/*    StreamLocation ns=new StreamLocation();
                      ...
                      onPressed: (){
                        ...
                        if (_formKey.currentState.validate()){
                          ...
                          if(_saved.length==0) {
                            ...
                            for(var i = 0; i < _saved.length; i++){
                              if(_saved[i].shifttype=='1'){
                                ...
                                if(_saved[i].timeout!='0:0' && _saved[i].timeout!='' && _saved[i].timeout!='00:00') {
                          ...
                          addBulkAtt(_saved)
                            ...
                            showInSnackBar('Unable to fetch location, Please make sure GPS is enable');
                            print(exp.toString());
                            setState(() {
                              _isButtonDisabled = false;
                            });
  ...
  getBulkEmpWidget() {
        ...
        return new Container(
          ...
          child: Form(
            ...
            child: new ListView.builder(
               ...
               print(til[1]);*/
                  TimeOfDay ti = TimeOfDay(
                      hour: int.parse(emplist[index].timein.split(":")[0]),
                      minute: int.parse(emplist[index].timein.split(":")[1]));
                  //print(ti);
                  TimeOfDay tout = TimeOfDay(
                      hour: int.parse(emplist[index].timeout.split(":")[0]),
                      minute: int.parse(emplist[index].timeout.split(":")[1]));
                  //print(tout);
                                      ...
                                      onChanged: (t) {
                                        ...
                                        setState(() {
                                          if (t != null)
                                            ...
                                            emplist[index].timeout = '00:00';
                                        });
                                        print(emplist[index].timeout);
                                      },
                                      /* validator: (time) {
                                      print(time);
    ...
    return new Container(
    child: new Center(child:Text('No data found...'),),
    );
