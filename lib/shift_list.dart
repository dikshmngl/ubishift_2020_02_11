                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Text('Shifts', style: TextStyle(color: appBarColor()),textAlign: TextAlign.left,),
                        ),
                        Container(
                          width: MediaQuery.of(context).size.width*0.22,
                          child: Text('Time in', style: TextStyle(color: appBarColor()),textAlign: TextAlign.left,),
                        ),
                        Container(
                          width: MediaQuery.of(context).size.width*0.22,
                          child: Text('Time out', style: TextStyle( color: appBarColor()),textAlign: TextAlign.left),
                        ),
                        Container(
